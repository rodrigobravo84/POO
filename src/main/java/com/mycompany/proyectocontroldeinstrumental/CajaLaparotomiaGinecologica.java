...
public class CajaLaparotomiaGinecologica extends CajaDeInstrumental {

    public CajaLaparotomiaGinecologica() {
    }
    ...
    public void mostrarDescripcion() {
        System.out.println("Esta caja cuenta con material para cirugia abdominal");
    }
